...
```{r programing-vs-ml, echo = FALSE, fig.cap = "", out.width = "50%"}
...
```{r learner-definition, fig.cap = "A learner learns a model from labeled training data. The model is used to make predictions.", echo = FALSE, out.width = "60%"}
...
```{r black-box, echo = FALSE, fig.cap  = "", out.width = "100%"}
