...
if (output == 'latex'){
  ...
  \\hypertarget{tocpage}{}
  \\bookmark[dest=tocpage,level=chapter]{Contents}
  \\tableofcontents
  \\phantomsection
  \\newpage')
  #cat('\nThis is the LaTeX output format.\n')
  }
```

# Summary {-}
```{r eval=FALSE, include=FALSE}
print(rmarkdown::all_output_formats(knitr::current_input()))
print(output)
```


```{r cover, cache=FALSE, eval = is.html, out.width="60%", fig.align="center"}
