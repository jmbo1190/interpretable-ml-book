...
```{r amazon-recommendation, fig.cap='Recommended products that are frequently bought together.', out.width="60%"}
...
```{r doge-stuck, fig.cap="Doge, our vacuum cleaner, got stuck. As an explanation for the accident, Doge told us that it needs to be on an even surface.", out.width="100%"}
