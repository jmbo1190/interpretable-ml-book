...
```{r, fig.cap = "Prototypes and criticisms for a data distribution with two features x1 and x2.", out.width="100%"}
set.seed(1)
...
This chapter presents MMD-critic by Kim et. al (2016)[^critiqueb], an approach that combines prototypes and criticisms in a single framework.
...
```{r mmd, fig.cap = "The squared maximum mean discrepancy measure (MMD2) for a dataset with two features and different selections of prototypes.", out.width="100%", cache = FALSE}
set.seed(42)
n = 40
...
```{r witness, fig.cap = "Evaluations of the witness function at different points.", out.width="100%", cache = FALSE, dependson = "mmd"}
...
```{r, prototypes-and-criticisms2, fig.cap = "Prototypes for a handwritten digits dataset.", out.width="75%"}
...
[^critiqueb]: Kim, Been, Rajiv Khanna, and Oluwasanmi O. Koyejo. "Examples are not enough, learn to criticize! Criticism for interpretability." Advances in Neural Information Processing Systems (2016).
